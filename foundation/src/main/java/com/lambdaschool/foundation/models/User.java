...
//    Owners & Renters Combinations
    @OneToMany(mappedBy = "user", cascade = CascadeType.ALL, orphanRemoval = true)
    @JsonIgnoreProperties(value = {"user", "owneditemid"}, allowSetters = true)
    private List<Owneditem> owneditems = new ArrayList<>();

    @OneToMany(mappedBy = "user", cascade = CascadeType.ALL, orphanRemoval = true)
    @JsonIgnoreProperties(value = {"user", "renteditemid"}, allowSetters = true)
